...
def takeRaw(x0):
    ...
    for y0 in np.arange(1, 1000, 1):
        ...
        bufB2=(1000-b2)/2
        xy=Point(x0,y0)
        firstKvPoindo=commonWithOval(xy, (a1-bufA)/2, (b1-bufB)/2)
        firstKvPoinposle=commonWithOval(xy, a1+bufA, b1+bufB)
        secondKvPoinDo=commonWithOval(xy, a2-bufA, b2-bufB)
        secondKvPoinPosle=commonWithOval(xy, a2+bufA2, b2+bufB2)
        oversdKvPoin=commonWithOval(xy, 1000, 1000)
...
im.save("out2/heatbackground5acircle.png")
im.show()
